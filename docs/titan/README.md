...
- [`preferences-and-feature-flags.md`](./preferences-and-feature-flags.md) — `titan.*` preference namespace, conservative defaults, feature-flag lifecycle, privacy gates, diagnostics, and rollback policy.
